...
public class SarcCasoEntity implements Serializable {	
	...
	public SarcCasoEntity(int id_caso, String tx_asunto, String fe_caso,
	...
	public String toString() {
		return "SarcCasoEntity [id_caso=" + id_caso + ", tx_asunto="
				+ tx_asunto + ", fe_caso=" + fe_caso + ", tx_descripcion="
				+ tx_descripcion + "]";
	}
}
