...
@javax.persistence.Table(name = "VM_ANT_BLOQUEOS_VEH_CTE", schema = "REPDIN", catalog = "")
@Entity
public class VmAntBloqueosVehCteEntity {


    private VmAntBloqueosVehCteEntityPK vmAntBloqueosVehCteEntityPK;

    @Id
    public VmAntBloqueosVehCteEntityPK getVmAntBloqueosVehCteEntityPK() {
        return vmAntBloqueosVehCteEntityPK;
    }

    public void setVmAntBloqueosVehCteEntityPK(VmAntBloqueosVehCteEntityPK vmAntBloqueosVehCteEntityPK) {
        this.vmAntBloqueosVehCteEntityPK = vmAntBloqueosVehCteEntityPK;
    }
    ...
    public boolean equals(Object o) {
        ...
        VmAntBloqueosVehCteEntity that = (VmAntBloqueosVehCteEntity) o;
