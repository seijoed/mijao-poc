...
@javax.persistence.Table(name = "VM_ANT_DATOS_LICENCIA_CTE", schema = "REPDIN", catalog = "")
@Entity
public class VmAntDatosLicenciaCte {

    private AntDatosLicenciaCtePK antDatosLicenciaCtePK;

    @Id
    public AntDatosLicenciaCtePK getAntDatosLicenciaCtePK() {
        return antDatosLicenciaCtePK;
    }

    public void setAntDatosLicenciaCtePK(AntDatosLicenciaCtePK antDatosLicenciaCtePK) {
        this.antDatosLicenciaCtePK = antDatosLicenciaCtePK;
    }
