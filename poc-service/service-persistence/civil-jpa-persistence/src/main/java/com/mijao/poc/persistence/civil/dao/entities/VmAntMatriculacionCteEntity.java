...
@javax.persistence.Table(name = "VM_ANT_MATRICULACION_CTE", schema = "REPDIN", catalog = "")
@Entity
public class VmAntMatriculacionCteEntity {

    private VmAntMatriculacionCteEntityPK vmAntMatriculacionCteEntityPK;

    @Id
    public VmAntMatriculacionCteEntityPK getVmAntMatriculacionCteEntityPK() {
        return vmAntMatriculacionCteEntityPK;
    }

    public void setVmAntMatriculacionCteEntityPK(VmAntMatriculacionCteEntityPK vmAntMatriculacionCteEntityPK) {
        this.vmAntMatriculacionCteEntityPK = vmAntMatriculacionCteEntityPK;
    }

    private int especie;

    @javax.persistence.Column(name = "ESPECIE")
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        VmAntMatriculacionCteEntity that = (VmAntMatriculacionCteEntity) o;
